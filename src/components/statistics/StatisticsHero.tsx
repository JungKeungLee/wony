...
export default function StatisticsHero() {
  return (
    <section className="relative flex flex-col items-center gap-6 px-6 pb-14 pt-32 text-center sm:pt-40">
      <HiddenStar id="statistics" className="absolute right-5 top-20 sm:right-8 sm:top-24" />
      <span className="font-display text-xs tracking-[0.4em] text-star">
        YEAR IN REVIEW
      </span>
      <h1 className="font-display text-4xl leading-tight tracking-wide text-text sm:text-6xl">
        WONY 2026
        <br />
        BY THE NUMBERS
      </h1>
